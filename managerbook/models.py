...
class Book(models.Model):
	...
	publish_year = models.DateTimeField(verbose_name='图书出版日期')
	publish_add = models.DateTimeField(verbose_name='图书添加时间',auto_now=True)
				# 时间自动添加
